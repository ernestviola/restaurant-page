...
This is a restaurant page built using html, css, javascript, and webpack. This
is an assignment found on [The Odin Project](https://www.theodinproject.com/lessons/node-path-javascript-restaurant-page).
